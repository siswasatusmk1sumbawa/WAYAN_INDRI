          ...
          <div class="col-sm-3 my-1">
            <div class="card">
              ...
              <div class="card-footer">
                ...
                ?>
                <a href="admin.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-danger">like (
                    <?= mysqli_num_rows($sql2) ?>)
                  </button></a>
                <a href="komentar.php?fotoid=<?= $data['fotoid'] ?>"><button type="button"
                    class="btn btn-warning">Komentar (
                    <?= mysqli_num_rows($sql3) ?>)
                  </button></a>
              </div>
            </div>
          </div>
